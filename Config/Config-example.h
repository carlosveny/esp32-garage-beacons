...
const String KNX_IP_ADDRESS = "XX.XX.XX.XX";               // IP Address of the KNX sender
const String BLE_ADDRESSES[] = { "XX:XX:XX:XX:XX:XX" };    // BLE devices addresses
const String KNX_ADDRESSES[] = { "X/X/X" };                // KNX addresses to write when devices are found
const String KNX_READ_ADDRESSES[] = { "Y/Y/Y" };           // KNX addresses to listen in order to start scanning
